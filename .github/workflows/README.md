...
| poetry-version    |    ❌    |                "1.3.2"                | string  | Poetry version to be installed                                                                                                    |
...
jobs:
  call-workflow-passing-data:
    ...
    with:
      ...
      poetry-version: 1.2.2 # (Optional) Default value is 1.3.2. In this case Poetry version 1.2.2 is installed
